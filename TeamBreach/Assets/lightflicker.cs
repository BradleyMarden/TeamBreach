...
public class lightflicker : MonoBehaviour
{
    ...
    [SerializeField] private float m_FlickerSpeed, m_IntensityMin, m_IntensityMax, m_SpotAngleMin, m_SpotAngleMax;
    ...
    void Update()
    {
       ...
       // m_Light.spotAngle = Mathf.Lerp(m_Light.spotAngle, m_SpotAngle, m_Time *Time.deltaTime);
